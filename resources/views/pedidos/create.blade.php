...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-100">
        <!-- Sección de encabezado con menú de navegación -->
        ...
        <main>
          <div class="container py-4">
            ...
            <div class="mb-3 row">
                <label for="pedido" class="col-sm-2 col-form-label">Pedido</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="pedido" id="pedido" value="{{ old('pedido')}}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                <label for="fecha" class="col-sm-2 col-form-label">Fecha de Pedido</label>
                <div class="col-sm-5">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    <select name="zona" id="zona" class="form-select" required>
                        <option value="">Seleccion Zona</option>
